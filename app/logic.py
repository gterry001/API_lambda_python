...
def build_portfolio_table(portfolio: pd.DataFrame, dfs: dict, invested_capital: float = 5e3, total_vol: float = 0.5) -> pd.DataFrame:
    """
...
def prepare_dashboard_data(portfolio: pd.DataFrame, df_betas: pd.DataFrame) -> dict:
    ...
    Esto se devolverá desde la API y WordPress podrá renderizarlo con Plotly.js.
    """
